...
function AddPortfolioImages() {
    ...
    const { id } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useParams"])(); // id من URL
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // ✅ إعادة التوجيه إلى بروفايل العامل المسجل
            if (saveData?.workerId) {
                router.push(`/viewprofile/${saveData.workerId}/portfolio`);
            } else {
                router.push("/"); // fallback في حالة عدم وجود workerId
            }
        } catch (err) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c962a2._.js.map